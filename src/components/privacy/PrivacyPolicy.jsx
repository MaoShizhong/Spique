...
export function PrivacyPolicy() {
    return (
        <main className={`privacy ${styles.privacy}`}>
            <Link to="/" aria-label="Logo. Link back to homepage.">
                <img src="/spique-full.png" alt="logo image" />
            </Link>

            <h1>Privacy Policy</h1>
            <p>Last updated: 28th October 2023</p>
            <p>
            ...
            <ul>
                ...
                <li>
                    <p>
                        <strong>Website</strong> refers to Spique, accessible from{' '}
                        <a
                            href="https://spique.netlify.app/"
                            rel="external nofollow noopener noreferrer"
                            target="_blank"
                        >
                            https://spique.netlify.app/
                        </a>
                    </p>
                </li>
                <li>
            ...
            <p>
                ...
                to manage Your personal information. Deletion of an account, including accounts
                authenticated via Github, will have all account details deleted.
            </p>
            <p>
                Any messages sent through this Service by an account will not be deleted upon
                deletion of the associated account. Instead, they will be marked as being sent by a{' '}
                <b>deleted user</b>.
            </p>
            <p>
            ...
            <h2>Contact Us</h2>
            <p>
                If you have any questions about this Privacy Policy, You can contact us on:
                privacy.spique@gmail.com (dummy email)
            </p>
        </main>
    );
}
